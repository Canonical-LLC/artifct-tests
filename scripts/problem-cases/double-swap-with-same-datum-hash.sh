...
redeemerFile="$baseDir/shared-redeemers/buy-redeemer.json"
...
utxoScript1=$(scripts/query/sc.sh | grep $datumHash1 | head -n 1 | cardano-cli-balance-fixer parse-as-utxo)
utxoScript2=$(scripts/query/sc.sh | grep $datumHash1 | tail -n 1 | cardano-cli-balance-fixer parse-as-utxo)
